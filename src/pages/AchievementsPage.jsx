  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="relative bg-gradient-to-br from-primary-500 via-accent-500 to-primary-600 text-white py-12 sm:py-16 overflow-hidden">
        ...
        <div className="absolute top-8 right-8 w-16 h-16 bg-white/10 rounded-2xl rotate-45 animate-float"></div>
        <div className="absolute top-24 left-16 w-12 h-12 bg-accent-400/20 rounded-full animate-float"></div>
        <div className="absolute bottom-12 left-1/3 w-10 h-10 bg-white/15 rounded-lg rotate-12 animate-float"></div>
